...
build = {
  ...
  modules = {
    ...
    ["lua_libp2p.relay.autorelay"] = "lua_libp2p/relay/autorelay.lua",
    ["lua_libp2p.relay.client"] = "lua_libp2p/relay/client.lua",
    ...
    ["lua_libp2p.protocol.circuit_relay_v2"] = "lua_libp2p/protocol/circuit_relay_v2.lua",

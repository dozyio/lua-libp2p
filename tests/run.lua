...
local tests = {
  ...
  (require("tests.integration.host_advertise_listener_stability")),
  (require("tests.integration.host_accept_burst_drain")),
  (require("tests.integration.host_dual_stack_same_port_stability")),
  (require("tests.integration.host_inbound_churn_stability")),
  ...
  (require("tests.unit.autonat_server")),
  ...
  (require("tests.unit.tls_alpn_muxer")),
  (require("tests.unit.tls_protocol")),
  (require("tests.unit.tls_vectors")),

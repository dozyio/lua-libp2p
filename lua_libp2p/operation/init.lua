...
---@class Libp2pOperationOptions
---@field result_count? integer Number of result slots before trailing error.

---@class Libp2pOperationResultOptions
---@field ctx? table
---@field timeout? number
---@field poll_interval? number

---@class Libp2pOperation
---@field id fun(self: Libp2pOperation): integer|nil
---@field task fun(self: Libp2pOperation): table|nil
---@field status fun(self: Libp2pOperation): string
---@field cancel fun(self: Libp2pOperation): true|nil, table|nil
---@field result fun(self: Libp2pOperation, opts?: Libp2pOperationResultOptions): any

---Create an operation wrapper around a task.
---@param host Libp2pHost Host instance.
---@param task table Task handle.
---@param opts? Libp2pOperationOptions
---@return Libp2pOperation|nil operation
...
---@param opts? Libp2pOperationResultOptions
---@return any ... Task result values, plus trailing error slot.

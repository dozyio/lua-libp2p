...
---@alias Libp2pLogLevel 'debug'|'info'|'warn'|'error'

---@class Libp2pLogger
---@field log fun(level_name: Libp2pLogLevel, message: string, fields?: table): true|nil, string|nil
---@field debug fun(message: string, fields?: table): true|nil, string|nil
---@field info fun(message: string, fields?: table): true|nil, string|nil
---@field warn fun(message: string, fields?: table): true|nil, string|nil
---@field error fun(message: string, fields?: table): true|nil, string|nil
---@field enabled fun(level_name: Libp2pLogLevel, fields?: table): boolean|nil, string|nil

---@class Libp2pLogSnapshot
---@field current_level integer
---@field subsystem_levels? table<string, integer>
---@field default_subsystem_level? integer
...
--- name string One of `debug|info|warn|error`.
--- true|nil ok
--- string|nil err
...
--- level_name Libp2pLogLevel One of `debug|info|warn|error`.
--- message string Log message.
--- fields? table Key/value metadata.
--- true|nil ok
--- string|nil err
